...
class ScheduleViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    var noofrows1 : [Int] = [1,1,1,4,1,4,1,1]
    ...
    var section3headings = ["title","title","title","title"]
    ...
    var imagename1 = ["registration","kb","group","","Clinic","","","Close"]
    var section3imagesname1 = ["user","user","user","user"]
    ...
    var section6imagesname1 = ["group","user","Srinivas_Chinta_uxindia","Muzayun_uxindia","group","narender_uxindia","shyam_uxindia","sirajuddin_uxindia","group"]
    
    var imagenames1 = ["","BAPU KALADHAR","","","","","",""]
    var section3imagesnames1 = ["SPEAKER","SPEAKER","SPEAKER","SPEAKER"]
    ...
    var section3heading2 = ["Title","Title","Title","Title"]
    var section5heading2 = ["Title","Title","Title","Title"]
    ...
    let section3submatters2 = ["Workshop 05","Workshop 06","Workshop 07","Workshop 08"]
    let section5submatters2 = ["Workshop 09","Workshop 10","Workshop 11","Workshop 12"]
    ...
    let section3imageName2 = ["user","user","user","user"]
    let section5imageName2 = ["user","user","user","user"]
    
    
    var imagenames2 = ["","PABLO SANCHEZ","STEVE FADDEN","","","","",""]
    let section3imagenames2 = ["SPEAKER","SPEAKER","SPEAKER","SPEAKER"]
    let section5imagenames2 = ["SPEAKER","SPEAKER","SPEAKER","SPEAKER"]
    ...
    func tableView(_ tableView: UITableView, willSelectRowAt indexPath: IndexPath) -> IndexPath? {
        if imagenames[(indexPath as NSIndexPath).section] == ""
        {
            ...
            //        else if imagenames1[(indexPath as NSIndexPath).section] == "" || section3imagesnames1[(indexPath as NSIndexPath).section] == "" || section5imagesnames1[(indexPath as NSIndexPath).section] == "" || section6imagesnames1[(indexPath as NSIndexPath).section] == ""{
            //            return nil
            //        }
        else{
            return indexPath
